...
export default {
 ...
 mounted(){
   ...
   axios
      .get('http://10.177.68.59:8090/QuinBookPost/getAllPostByUserName/'+localStorage.getItem('myFriendName')) // Deepak - for Checking Block
      .then(response => {
   ...
   axios
   .get('http://10.177.68.53:8081/getDetails/userName?userName='+this.myFriendName,{ headers: { sessionId: localStorage.getItem('sessionId') } }) //ishika - for about post
   .then(response => {
     console.log(response)
